...
function showPosition(position)
{
  ...
  //      document.getElementById('geoImage').style.backgroundImage
  //      ="url(http://lxhao.sinaapp.com/geofix.php?longitude="+position.coords.longitude+"&latitude="+position.coords.latitude+")"; //改变背景图片  
...
include 'inc/conn.php';
	...
	<form id='form1' action="createUser.php" method="post"><!--输出表单头-->
          ...
          <?php if(strpos($_SERVER["HTTP_USER_AGENT"],"iPod") || strpos($_SERVER["HTTP_USER_AGENT"],"iPhone") || strpos($_SERVER["HTTP_USER_AGENT"],"iPad")){?>
          头像:
          <span id="picUrl"><img height="30" src="./static/images/iphoneAvater.png" /></span>(IOS浏览器无法更换)
          <div style="clear:both;"></div>
          <input type="hidden" id="avater" name="avater" value="./static/images/iphoneAvater.png">
          <?php }else{?>
          
          <iframe src="./helper/upload.php" style="border:0; padding:0px;margin:0px;width:100%;height:30px;overflow:hidden; line-height:28px;  display:inline;float:left;" ></iframe>
          <div style="clear:both;"></div>
	...
	<select id='province' name="province" onchange='queryCity(this.options[this.selectedIndex].value)'>
	<!--输出下拉列表项值-->
	...
	<span id='city'></span><!--显示数据的城市的位置-->
          ...
          <input class="subbtn"  type="submit" value="注册找老乡" />
	</form><!--表单项结尾-->
